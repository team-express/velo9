		...
		mockMvc.perform(post("/write")
			...
			.andDo(document("writePost",
				relaxedRequestFields(
					...
					fieldWithPath("title").description("제목"),
					fieldWithPath("introduce").description("비어있을 경우 content의 150자 이내가 소개글이 됩니다.").optional(),
					fieldWithPath("content").description("본문내용"),
					fieldWithPath("access").description("PUBLIC(전체공개), PRIVATE(비공개) 중에서 적습니다. 적지 않으면 public으로 동작합니다."),
