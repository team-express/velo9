...
include::{snippets}/GetReadPost/request-parameters.adoc[]
...
include::{snippets}/GetLovePostRead/request-parameters.adoc[]
...
include::{snippets}/GetLookPostRead/request-parameters.adoc[]
